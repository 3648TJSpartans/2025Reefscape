...
import frc.robot.commands.goToCommands.DriveToNearest6;
import frc.robot.commands.goToCommands.DriveToNearest7;
...
public class CoralSequentialAutoCmd extends SequentialCommandGroup {
    ...
    public CoralSequentialAutoCmd(Drive drive, CoralIntake coralIntake,
        ...
        DriveToNearest6 driveCommand = new DriveToNearest6(m_drive, () -> CoralSequentialAutoCmd.poses(false));
        DriveToNearest7 drive2Command = new DriveToNearest7(m_drive, () -> CoralSequentialAutoCmd.poses(true));
    ...
    public static void setLevel(int level) {
        CoralSequentialAutoCmd.level = level;
        Logger.recordOutput("CoralSequentialCommand/level", level);
    }

    public static void setExact(boolean exact) {
        CoralSequentialAutoCmd.exact = exact;
