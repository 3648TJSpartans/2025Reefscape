...
public class DriveToNearest6 extends Command {
        ...
        public DriveToNearest6(Drive drive, Supplier<Pose2d[]> targets) {
                this.drive = drive;
                robot = drive::getPose;
        ...
        public DriveToNearest6(Drive drive, Supplier<Pose2d[]> targets, Supplier<Pose2d> robot) {
                this(drive, targets);
                this.robot = robot;
        }

        public DriveToNearest6(
                        Drive drive,
