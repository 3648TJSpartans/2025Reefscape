...
public class AutonConstants {
    ...
    public static class PoseConstants {
        ...
        private final static Pose2d[] closeBlueRightReefPoints = new Pose2d[] {
                new Pose2d(2.2, 3.85, Rotation2d.fromDegrees(0)), // Pose A
        ...
        private final static Pose2d[] closeBlueLeftReefPoints = new Pose2d[] {
                new Pose2d(2.2, 4.12, Rotation2d.fromDegrees(0)), // Pose B
        ...
        private final static Pose2d[] exactBlueRightReefPoints = new Pose2d[] {
        ...
        private final static Pose2d[] exactBlueLeftReefPoints = new Pose2d[] {
        ...
        public final static Pose2d[] closeRightReefPoints = AllianceFlipUtil.apply(closeBlueRightReefPoints);
        public final static Pose2d[] closeLeftReefPoints = AllianceFlipUtil.apply(closeBlueLeftReefPoints);
        public final static Pose2d[] exactRightReefPoints = AllianceFlipUtil.apply(exactBlueRightReefPoints);
        public final static Pose2d[] exactLeftReefPoints = AllianceFlipUtil.apply(exactBlueLeftReefPoints);
