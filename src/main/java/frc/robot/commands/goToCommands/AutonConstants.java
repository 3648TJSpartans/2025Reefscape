...
public class AutonConstants {
        ...
        public static class PoseConstants {
                ...
                private final static Pose2d[] l4ExactBlueRightReefPoints = new Pose2d[] {
                                new Pose2d(3.10, 4.17, Rotation2d.fromDegrees(0)), //

                                // HEY EVANGELIa UPDATE ALL OF OUR SETPOINTS USING ABOVE X AND Y VALUES!!! USE
                                // MICAH'S DESMOS GRAPH ON THE README

                                new Pose2d(3.65, 2.87, Rotation2d.fromDegrees(60)), // Pose D
                                new Pose2d(5.05, 2.7, Rotation2d.fromDegrees(120)), // Pose F
                                new Pose2d(5.9, 3.83, Rotation2d.fromDegrees(180)), // Pose H
                                new Pose2d(5.35, 5.13, Rotation2d.fromDegrees(240)), // Pose J
                                new Pose2d(3.95, 5.3, Rotation2d.fromDegrees(300)) // Pose L
                };

                private final static Pose2d[] l4ExactBlueLeftReefPoints = new Pose2d[] {
                                new Pose2d(3.10, 3.83, Rotation2d.fromDegrees(0)), // Pose B
                                new Pose2d(3.95, 2.7, Rotation2d.fromDegrees(60)), // Pose C
                                new Pose2d(5.35, 2.87, Rotation2d.fromDegrees(120)), // Pose E
                                new Pose2d(5.9, 4.17, Rotation2d.fromDegrees(180)), // Pose G
                                new Pose2d(5.05, 5.3, Rotation2d.fromDegrees(240)), // Pose I
                                new Pose2d(3.65, 5.13, Rotation2d.fromDegrees(300)) // Pose K
                };
