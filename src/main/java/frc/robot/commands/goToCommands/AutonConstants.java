...
public class AutonConstants {
    ...
    public static class PoseConstants {
        ...
        public final static Pose2d[] l4ExactRightReefPoints = AllianceFlipUtil.apply(l4ExactBlueRightReefPoints);
        public final static Pose2d[] l4ExactLeftReefPoints = AllianceFlipUtil.apply(l4ExactBlueLeftReefPoints);
        public final static Pose2d[] l2ExactRightReefPoints = AllianceFlipUtil.apply(l2ExactBlueRightReefPoints);
        public final static Pose2d[] l2ExactLeftReefPoints = AllianceFlipUtil.apply(l2ExactBlueLeftReefPoints);
        public final static Pose2d[] l1ExactRightReefPoints = AllianceFlipUtil.apply(l1ExactBlueRightReefPoints);
        public final static Pose2d[] l1ExactLeftReefPoints = AllianceFlipUtil.apply(l1ExactBlueLeftReefPoints);
        public final static Pose2d[] l4CloseRightReefPoints = AllianceFlipUtil.apply(l4CloseBlueRightReefPoints);
        public final static Pose2d[] l4CloseLeftReefPoints = AllianceFlipUtil.apply(l4CloseBlueLeftReefPoints);
        public final static Pose2d[] l2CloseRightReefPoints = AllianceFlipUtil.apply(l2CloseBlueRightReefPoints);
        public final static Pose2d[] l2CloseLeftReefPoints = AllianceFlipUtil.apply(l2CloseBlueLeftReefPoints);
        public final static Pose2d[] l1CloseRightReefPoints = AllianceFlipUtil.apply(l1CloseBlueRightReefPoints);
