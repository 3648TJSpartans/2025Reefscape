...
public class DriveToNearest5 extends Command {
        ...
        public DriveToNearest5(Drive drive, Supplier<Pose2d[]> targets) {
                this.drive = drive;
                robot = drive::getPose;
        ...
        public DriveToNearest5(Drive drive, Supplier<Pose2d[]> targets, Supplier<Pose2d> robot) {
                this(drive, targets);
                this.robot = robot;
        }

        public DriveToNearest5(
                        Drive drive,
