//src/main/java/frc/robot/commands/goToCommands/DriveToNearest5.java// Copyright (c) 2025 FRC 6328
...
public class DriveToNearest7 extends Command {
        ...
        public DriveToNearest7(Drive drive, Supplier<Pose2d[]> targets) {
                this.drive = drive;
                robot = drive::getPose;
        ...
        public DriveToNearest7(Drive drive, Supplier<Pose2d[]> targets, Supplier<Pose2d> robot) {
                this(drive, targets);
                this.robot = robot;
        }

        public DriveToNearest7(
                        Drive drive,
