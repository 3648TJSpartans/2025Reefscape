...
public class DriveToNearest2 extends Command {
        ...
        public DriveToNearest2(Drive drive, Supplier<Pose2d[]> targets) {
                this.drive = drive;
                robot = drive::getPose;
        ...
        public DriveToNearest2(Drive drive, Supplier<Pose2d[]> targets, Supplier<Pose2d> robot) {
                this(drive, targets);
                this.robot = robot;
        }

        public DriveToNearest2(
                        Drive drive,
