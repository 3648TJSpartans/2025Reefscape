...
public class DriveCommands {
  ...
  private static final double ANGLE_KP = turnKp;// 5.0;
  private static final double ANGLE_KD = turnKd;
  private static final double ANGLE_MAX_VELOCITY = 1;
  private static final double ANGLE_MAX_ACCELERATION = 1;
