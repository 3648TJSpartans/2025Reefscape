...
public class RobotContainer {
  ...
  private final ObjectiveTracker m_objectiveTracker = new ObjectiveTracker();
  // Controller
  ...
  private void configureTest() {
    TunableBoolean tunableFilled = new TunableBoolean("Test Tunable", false);
    new Trigger(() -> tunableFilled.hasChanged())
        .onTrue(new InstantCommand(() -> System.out.println(tunableFilled.get())));
